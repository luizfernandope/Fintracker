...
namespace FinTracker.TelasPrincipais
{
    public partial class Fornecedores : Form
    {
        ...
        {
            dataGridView1.DataSource = await fornecedorRepository.GetFornecedores();
        ...
        private async void txbPesquisa_TextChanged(object sender, EventArgs e)
        {
            if (txbPesquisa.Text == "")
                atualizarTabela();
            dataGridView1.DataSource = await fornecedorRepository.pesquisarEmTudo(txbPesquisa.Text);
